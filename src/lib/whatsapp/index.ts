...
export const META_TEMPLATE_MAP: Record<string, MetaTemplateMapping> = {
  'portal-invite': {
    ...
    bodyPreview: '*Welcome to your Elite Wealth portal*\n\nDear {FirstName},\n\nYour adviser *{AdviserName}* has invited you to activate your Elite Wealth client portal.\n\nYour portal is your shared one-stop-shop where you can plan for your financial future and monitor your finances together.\n\nPlease click the link below to get started.\n\nIf you have any questions, please don\'t hesitate to reach out to your adviser directly.',
  ...
  'info-request': {
    ...
    bodyPreview: 'Dear {FirstName},\n\nYour adviser *{AdviserName}* has requested some information from you.\n\nPlease tap the button below to complete the request *securely* through the Elite Wealth portal.\n\nIf you have any questions, please don\'t hesitate to reach out to your adviser directly.',
    footer: 'Elite Wealth © 2026',
    buttonLabel: 'Share the information',
  },
  'onboarding': {
    ...
    bodyPreview: '*We\'re excited to have you here!*\n\nYour adviser *{AdviserName}* has started your onboarding process.\n\n*We need some information.*\nPlease go through each section and fill out as much information as you can. The more detail you provide, the better financial advice your adviser can offer you.\n\n*This is a secure process.*\n\nIf you have any questions, please don\'t hesitate to reach out to your adviser directly.',
    footer: 'Elite Wealth © 2026',
  ...
  'document-request': {
    ...
    bodyPreview: 'Dear {FirstName},\n\nYour adviser *{AdviserName}* has requested the following documents from you: *{DocumentList}*.\n\nIf you have any questions, please reach out to your adviser directly.',
    footer: 'Elite Wealth © 2026',
  ...
  'share-document': {
    ...
    bodyPreview: 'Dear {FirstName},\n\n*Your adviser {AdviserName} has shared a document with you.*\n\nIf you have any questions, please don\'t hesitate to reach out to your adviser directly.',
    footer: 'Elite Wealth © 2026',
