    ...
    <AppLayout>
      <div className="comms-dashboard">
        ...
        <nav className="tabs">
          ...
          <Link href="/comms-hub/templates" className="tab active">
            Templates
          </Link>
        ...
        <div className="card">
          <div className="card-body" style={{ padding: 'var(--spacing-xl)', textAlign: 'center' }}>
            ...
            <h2 style={{ fontSize: 'var(--font-size-lg)', fontWeight: 'var(--font-weight-semibold)', marginBottom: 'var(--spacing-sm)' }}>Templates</h2>
            <p style={{ color: 'var(--color-text-muted)' }}>Message templates management — coming soon</p>
          </div>
        </div>
      </div>
    </AppLayout>
