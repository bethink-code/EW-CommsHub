...
export const MOCK_CLIENTS: Client[] = [
  { id: 'c1', firstName: 'Johan', lastName: 'Pretorius', email: 'hello@bethink.co.za', phone: '+27 83 496 6860', preferredChannel: 'email' },
  { id: 'c2', firstName: 'Sarah', lastName: 'van der Berg', email: 'hello@bethink.co.za', phone: '+27 83 496 6860', preferredChannel: 'whatsapp' },
  { id: 'c3', firstName: 'Michael', lastName: 'Naidoo', email: 'hello@bethink.co.za', phone: '+27 83 496 6860', preferredChannel: 'email' },
  { id: 'c4', firstName: 'Peter', lastName: 'Gillespie', email: 'hello@bethink.co.za', phone: '+27 83 496 6860', preferredChannel: 'sms' },
  { id: 'c5', firstName: 'David', lastName: 'Smit', email: 'hello@bethink.co.za', phone: '+27 83 496 6860', preferredChannel: 'whatsapp' },
  { id: 'c6', firstName: 'Nomsa', lastName: 'Dlamini', email: 'hello@bethink.co.za', phone: '+27 83 496 6860', preferredChannel: 'email' },
  { id: 'c7', firstName: 'Priya', lastName: 'Govender', email: 'hello@bethink.co.za', phone: '+27 83 496 6860', preferredChannel: 'email' },
  { id: 'c8', firstName: 'Thabo', lastName: 'Molefe', email: 'hello@bethink.co.za', phone: '+27 83 496 6860', preferredChannel: 'whatsapp' },
  { id: 'c9', firstName: 'James', lastName: 'Wilson', email: 'hello@bethink.co.za', phone: '+27 83 496 6860', preferredChannel: 'email' },
  { id: 'c10', firstName: 'Linda', lastName: 'Nkosi', email: 'hello@bethink.co.za', phone: '+27 83 496 6860', preferredChannel: 'email' },
  { id: 'c11', firstName: 'Robert', lastName: 'du Plessis', email: 'hello@bethink.co.za', phone: '+27 83 496 6860', preferredChannel: 'sms' },
  { id: 'c12', firstName: 'Fatima', lastName: 'Patel', email: 'hello@bethink.co.za', phone: '+27 83 496 6860', preferredChannel: 'whatsapp' },
  { id: 'c13', firstName: 'André', lastName: 'Botha', email: 'hello@bethink.co.za', phone: '+27 83 496 6860', preferredChannel: 'email' },
  { id: 'c14', firstName: 'Grace', lastName: 'Mthembu', email: 'hello@bethink.co.za', phone: '+27 83 496 6860', preferredChannel: 'whatsapp' },
  { id: 'c15', firstName: 'Willem', lastName: 'Jacobs', email: 'hello@bethink.co.za', phone: '+27 83 496 6860', preferredChannel: 'email' },
  { id: 'c16', firstName: 'Sipho', lastName: 'Zulu', email: 'hello@bethink.co.za', phone: '+27 83 496 6860', preferredChannel: 'sms' },
  { id: 'c17', firstName: 'Emma', lastName: 'Kruger', email: 'hello@bethink.co.za', phone: '+27 83 496 6860', preferredChannel: 'email' },
];
...
export const MOCK_INFO_REQUESTS: InfoRequest[] = [
  ...
  {
    id: 'ir-4',
    client: { id: 'c18', firstName: 'Lisa', lastName: 'Thompson', email: 'hello@bethink.co.za', phone: '+27 83 496 6860', preferredChannel: 'email' },
    status: 'complete',
...
export const MOCK_CLIENTS_WITH_LISA: Client[] = [
  ...MOCK_CLIENTS,
  { id: 'c18', firstName: 'Lisa', lastName: 'Thompson', email: 'hello@bethink.co.za', phone: '+27 83 496 6860', preferredChannel: 'email' },
];
