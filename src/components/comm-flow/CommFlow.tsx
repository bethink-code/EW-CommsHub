  ...
  if (context.renderMode === 'modal') {
    ...
    return (
      <Modal
        isOpen={true}
        onClose={context.onCancel || (() => {})}
        title={context.modalTitle || (flow.data.commType ? (COMM_TYPE_CONFIGS[flow.data.commType]?.modalTitle || COMM_TYPE_CONFIGS[flow.data.commType]?.name || 'New Communication') : 'New Communication')}
        size="lg"
